            ...
            <div className="mx-auto flex max-w-[560px] flex-col gap-6 border-t border-[#E5E3DF] pt-6 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:justify-between lg:gap-12">
              ...
              <div className="border-t border-[#E5E3DF] pt-6 lg:border-t-0 lg:pt-0">
                ...
                <div className="flex flex-wrap items-center gap-x-5 gap-y-3 lg:justify-end lg:gap-x-6">
                  ...
                  <img src="/images/media/bild-der-frau.webp" alt="Bild der Frau" loading="lazy" decoding="async" className="hidden h-[20px] object-contain opacity-80 sm:block" />
                  <img src="/images/media/frankfurter-allgemeine.webp" alt="Frankfurter Allgemeine" loading="lazy" decoding="async" className="hidden h-[20px] object-contain opacity-80 sm:block" />
                </div>
              </div>
