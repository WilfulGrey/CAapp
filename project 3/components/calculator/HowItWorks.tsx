          ...
          <div className="flex md:flex-col gap-5">
            ...
            <div className="pt-0.5 md:pt-5 flex-1">
              ...
              <p className="text-[16px] leading-[1.55] text-[#5A5A5A] mb-2.5">
                Pflegegrad, Mobilität, Hilfe in der Nacht — daraus ergibt sich Ihr Preis, samt Zuschüssen und Steuervorteilen. Die Kontaktdaten brauchen wir, um Ihnen alles zuzuschicken.
              </p>
