      ...
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-2 text-white/90">
            ...
            <span className="text-[16px] font-medium">100% kostenfrei & unverbindlich</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 w-full max-w-[340px]">
            <p className="text-white/70 text-[15px]">Lieber direkt Kontakt aufnehmen?</p>
            <a
              href="tel:+4989200000830"
              className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors border border-white/20"
            >
            ...
            >
              ...
              <span className="text-white font-semibold text-[16px]">WhatsApp schreiben</span>
            </a>
          </div>
        </div>
      </div>
