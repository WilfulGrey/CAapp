      ...
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-6">
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#E76F63] hover:bg-[#D65E52] text-white rounded-xl text-base md:text-lg font-bold shadow-lg hover:shadow-xl transition-all duration-200"
          >
