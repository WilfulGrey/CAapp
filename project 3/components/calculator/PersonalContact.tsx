 ...
 * als Martins Entscheidung vom 13.08. dokumentiert: Ueberschrift ueber die
 * volle Breite, darunter Foto mit Name/Rolle daneben, dann der Text wieder
 * volle Breite, und die beiden Wege NEBENEINANDER.
 *
 * Die alte Rechner-Fassung stammte von davor (zentrierte Ueberschrift,
 * 96px-Foto mit Ring, drei gestapelte Icon-Links, Verlauf im Hintergrund)
 * und war nie nachgezogen worden — sie war zuletzt auch gar nicht mehr
 ...
 *   dieser Karte — das Portal faehrt weiter Pillen, bis es nachgezogen wird.
 */
...
export function PersonalContact({
  headline = 'Kann ich helfen?',
  body = 'Ich helfe Ihnen gerne weiter — schnell und unverbindlich.',
  ...
  return (
    <div className="rounded-2xl border border-[#D4D4D8] bg-white p-4 shadow-sm">
      ...
      <div className="flex gap-2">
        {/* Reihenfolge wie im Portal und wie im Footer: Anrufen, dann
            WhatsApp. Die Nummer selbst steht unten in der Kontaktbox —
            hier zaehlt der kurze Weg. */}
        <a
          href={PHONE_HREF}
          className="flex-1 inline-flex items-center justify-center gap-2 text-[15px] font-semibold bg-white text-[#3D2B1F] border border-[#E9E9EB] px-4 py-2.5 rounded-xl hover:bg-gray-50 transition-colors"
        >
        ...
        <a
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 text-[15px] font-semibold bg-[#25D366] text-white px-4 py-2.5 rounded-xl hover:bg-[#1FB854] transition-colors"
        >
