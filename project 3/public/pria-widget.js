...
function fuerWenChips(){
  ...
  return [
    {t:'Für meine Mutter',f:b=>start(b,'1','Für meine Mutter')},
    {t:'Für meinen Vater',f:b=>start(b,'1','Für meinen Vater')},
    {t:'Für meine Eltern',f:b=>start(b,'2','Für meine Eltern')},
    {t:'Für jemand anderen',stil:'soft',f:b=>starteFunnel('preis',b,'Für jemand anderen')}
  ];
}
