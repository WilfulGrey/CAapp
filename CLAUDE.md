...
`angaben-labels.ts` (Registry #55), `oaiq.ts`, `pflegena.ts` (Registry #59), `zaehler.ts` (Registry #63), `wachstum.ts` (Registry #71), `telefon.ts` (Telefon im Kontakt-Schritt: nur Ziffern/+/Trennzeichen, 8–15 Ziffern; Server bleibt bei ≥6).
