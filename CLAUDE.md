...
| `project 3/app/api/bewertungen-stand/route.ts` | Schnitt und Anzahl aller Bewertungen für die Preisseite — reicht `https://primundus.de/api/bewertungen-stand` stündlich gecacht über die eigene Domain durch (502 + keine Zeile, wenn die Quelle ausfällt; nie eine Zahl aus dem Code) |
