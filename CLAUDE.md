...
| `project 3/lib/pflegena.ts` | Vermittler-Anfragen (Prosa) → Standard-Body: Tool-Schema + Prompt + **pure** Prüfung (`pruefeAnfrage`, Whitelist `ERLAUBT`), `betreffAntwort`, `VERMITTLER_MAILS`. Netzaufruf steht in portal-abholen (Muster Pria). Test: `src/__tests__/pflegena.test.ts` |
