      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="rounded-2xl overflow-hidden border" style={{background:'white', borderColor:'#E5E3DF'}}>
          {[
            ...
            { q: 'Was bedeuten die Deutsch-Niveaus (Grund, Mittel, Gut)?', a: 'Wir zeigen die Deutschkenntnisse jeder Pflegekraft in drei einfachen Stufen, damit Sie das Niveau auf einen Blick einordnen können:\n\n• ● Grund — einfache Sätze für den Alltag: Begrüßung, Zahlen, kurze Fragen. Verständigung mit etwas Geduld und Mimik möglich.\n• ●● Mittel — solider Alltag: führt typische Pflegegespräche, versteht Anweisungen und teilt Beobachtungen verlässlich mit.\n• ●●● Gut — sicher in fast allen Situationen: führt auch komplexere Gespräche, versteht Diagnosen und Medikamentenpläne mühelos.\n\nDie Punkte (1 bis 3) auf der Karte zeigen das Niveau visuell.' },
          ].map((item, i, arr) => (
