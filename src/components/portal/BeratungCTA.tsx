    ...
    <div className="rounded-2xl border border-[#E9E9EB] bg-[#F5F5F6] p-4">
      <div className="flex items-start gap-3">
        <img
          src="/ilka.webp"
          alt="Ilka Wysocki"
          className="w-16 h-16 rounded-full object-cover object-top flex-shrink-0 border border-[#E9E9EB]"
        />
        <div className="flex-1 min-w-0">
          <p className="text-[17px] font-bold text-[#3D2B1F] leading-tight">{headline}</p>
          <p className="text-[14px] text-[#8B7355] font-medium mb-1.5">Ilka Wysocki · Ihre Beraterin</p>
          <p className="text-[16px] text-[#52525B] leading-relaxed mb-3">{body}</p>
