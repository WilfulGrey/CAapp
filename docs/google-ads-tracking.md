...
## Chat-Landingpage `/sofortangebot` (seit 26.08.2026, Staging-gated)
...
- **Varianten-Marker:** `analytics_sessions.landing_page = '/sofortangebot'`
...
- **Gate:** Route liefert außerhalb von
  ...
  (`app/sofortangebot/page.tsx`, ERLAUBTE_HOSTS) — Prod-Schaltung ist ein
